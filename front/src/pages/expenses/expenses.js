            ...
            <>
                ...
                <div className="icom">
                    <MDBContainer>
                        <MDBRow>
                            <MDBCol md="2">
                                <MDBBtn className='topBotomBordersOut' style={{ width: "150px" , background : 'transparent' , border : 'none' , color : "black" , "font-weight ": 'larger' }} onClick={() => this.openModal()} type="button" >Add expenses</MDBBtn>
                            </MDBCol>
                        </MDBRow>
                    </MDBContainer>
